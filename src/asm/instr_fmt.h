...
extern std::variant<instruction_format_t, Error> lookup(uint8_t opcode1, std::optional<uint8_t> opcode2);
...
extern const std::array<std::string_view, 110> instr_op_mneumonic;
