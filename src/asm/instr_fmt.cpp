...
std::array<instruction_format_t, 367> instr_tbl =
...
{
  {
         ...
         { operation_e::SETO,      0x0f,     0x90, { operand_e::RM8,     operand_e::NONE,    operand_e::NONE },      0x0 },
         { operation_e::SETNO,     0x0f,     0x91, { operand_e::RM8,     operand_e::NONE,    operand_e::NONE },      0x0 },
         { operation_e::SETB,      0x0f,     0x92, { operand_e::RM8,     operand_e::NONE,    operand_e::NONE },      0x0 },
         { operation_e::SETAE,     0x0f,     0x93, { operand_e::RM8,     operand_e::NONE,    operand_e::NONE },      0x0 },
         { operation_e::SETE,      0x0f,     0x94, { operand_e::RM8,     operand_e::NONE,    operand_e::NONE },      0x0 },
         { operation_e::SETNE,     0x0f,     0x95, { operand_e::RM8,     operand_e::NONE,    operand_e::NONE },      0x0 },
         { operation_e::SETBE,     0x0f,     0x96, { operand_e::RM8,     operand_e::NONE,    operand_e::NONE },      0x0 },
         { operation_e::SETA,      0x0f,     0x97, { operand_e::RM8,     operand_e::NONE,    operand_e::NONE },      0x0 },
         { operation_e::SETS,      0x0f,     0x98, { operand_e::RM8,     operand_e::NONE,    operand_e::NONE },      0x0 },
         { operation_e::SETNS,     0x0f,     0x99, { operand_e::RM8,     operand_e::NONE,    operand_e::NONE },      0x0 },
         { operation_e::SETP,      0x0f,     0x9a, { operand_e::RM8,     operand_e::NONE,    operand_e::NONE },      0x0 },
         { operation_e::SETNP,     0x0f,     0x9b, { operand_e::RM8,     operand_e::NONE,    operand_e::NONE },      0x0 },
         { operation_e::SETL,      0x0f,     0x9c, { operand_e::RM8,     operand_e::NONE,    operand_e::NONE },      0x0 },
         { operation_e::SETGE,     0x0f,     0x9d, { operand_e::RM8,     operand_e::NONE,    operand_e::NONE },      0x0 },
         { operation_e::SETLE,     0x0f,     0x9e, { operand_e::RM8,     operand_e::NONE,    operand_e::NONE },      0x0 },
         { operation_e::SETG,      0x0f,     0x9f, { operand_e::RM8,     operand_e::NONE,    operand_e::NONE },      0x0 },
        ...
        // SEGMENT OVERRIDE: DS
         ...
         { operation_e::IMUL_TRUNC,0x69,     DNE,  { operand_e::R16,     operand_e::RM16,    operand_e::IMM16 },     0x0 },
         { operation_e::PUSH,      0x6a,     DNE,  { operand_e::IMM8,    operand_e::NONE,    operand_e::NONE },      0x0 },
         { operation_e::IMUL_TRUNC,0x6b,     DNE,  { operand_e::R16,     operand_e::RM16,    operand_e::IMM8 },      0x0 },
...
int instr_fmt_lookup(uint8_t opcode1, uint8_t opcode2, instr_fmt_t **_fmt)
{
  ...
  bool opcode1_found = false;
  for (size_t i = 0; i < instr_tbl.size(); i++) {
    const instruction_format_t& fmt = instr_tbl[i];
...
const std::array<std::string_view, 110> instr_op_mneumonic =
{
    "aaa",    "aas",    "adc",    "add",
    "and",    "call",   "callf",  "cbw",
    "clc",    "cld",    "cli",    "cmc",
...
std::variant<instruction_format_t, Error> lookup(uint8_t opcode1, std::optional<uint8_t> opcode2)
{
  // TODO FIXME .. VERY INEFFICENT O(N) SEARCH
  // WE COULD DO A BINARY SEARCH, BUT REALLY WE SHOULD JUST USE A TABLE
  // THAT'S MUCH MORE EFFICENT FOR O(1) LOOKUPS. WE COULD EITHER BUILD
  ...
  for (const instruction_format_t& fmt : instr_tbl)
  {
    if (opcode1 != fmt.opcode1)
      continue;
    op1_found = true;
  ...
  if (op1_found && !opcode2)
  {
    if (opcode1 != 0x0f)
      return Error::NeedOpcode2;
    else
      return Error::NeedOpcode2Ext0F;
  }
